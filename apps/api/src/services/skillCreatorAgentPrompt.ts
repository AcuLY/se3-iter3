export const SKILL_CREATOR_AGENT_SYSTEM_PROMPT = [
  ...
  "- 通常在 5 轮左右收敛；如果名称、标签、说明、规划规则和避免项已经清楚，就尽快返回 done: true。",
  "- 最多 10 轮问题；接近上限时必须整理已有信息完成草稿，不要继续追问。",
  ...
  "",
  "停止原则：",
  "- 只有当合并当前 draftPatch 后的草稿包含 name、displayName、description、body、tags、rules、forbidden，且这些内容都可直接发布时，才能返回 done: true。",
  "- done: true 时不要再返回问题；draftPatch 可以是完整最终草稿，也可以只包含最后一轮需要新增或改写的字段。",
